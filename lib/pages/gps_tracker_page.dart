...
class GPSTrackerPage extends StatefulWidget {
  static const String routeName = '/gps-tracker';
                  ...
                  MarkerLayer(
                    markers: [
                      ...
                      if (controller.locationHistory.length > 1)
                        ...List.generate(controller.locationHistory.length, (index) {
                ...
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: controller.locationType.value == 'gps'
                                  ? Colors.green.shade100
                                  : Colors.orange.shade100,
                              borderRadius: BorderRadius.circular(8),
                            ),
                            child: Text(
                              controller.getLocationTypeDescription(),
                              style: TextStyle(
                                fontSize: 11,
                      ...
                      // Coordinates
                      if (position != null) ...[
                        _buildInfoRow(cs, 'Koordinat:', '${position.latitude.toStringAsFixed(6)}, ${position.longitude.toStringAsFixed(6)}'),
                        const SizedBox(height: 8),
                        _buildInfoRow(cs, 'Akurasi:', '${controller.accuracy.value} m'),
                        const SizedBox(height: 8),
                        _buildInfoRow(cs, 'Ketinggian:', '${controller.altitude.value.toStringAsFixed(2)} m'),
                        const SizedBox(height: 8),
                        _buildInfoRow(cs, 'Kecepatan:', '${(controller.speed.value * 3.6).toStringAsFixed(2)} km/h'),
                        const SizedBox(height: 8),
                        _buildInfoRow(cs, 'Total Jarak:', '${controller.totalDistance.value.toStringAsFixed(3)} km'),
                        const SizedBox(height: 8),
                        _buildInfoRow(cs, 'Lokasi:', controller.currentAddress.value),
                      ] else
                        Text(
                          'Mendapatkan lokasi...',
